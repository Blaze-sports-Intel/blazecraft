    ...
    render(state) {
        ...
        if (state.events.length) {
            ...
            if (latest.timestamp > this.lastEventTs) {
                ...
                if (w) {
                    if (latest.type === 'spawn')
                        this.addPing(w.position.x, w.position.y, 'spawn');
                    if (latest.type === 'error')
                        this.addPing(w.position.x, w.position.y, 'error');
                }
            }
        }
        // clear
